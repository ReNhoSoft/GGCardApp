  ...
  },
  {
    ...
    valueSets: [
      ...
      },
      {
        ...
        values: [
          { value: "Anila", icon: "/games/GBVSR/GBVSR_Anila_Icon.png", iconPosition:"50%60%" },
          ...
          { value: "Cagliostro", icon: "/games/GBVSR/GBVSR_Cagliostro_Icon.png", iconPosition:"50%60%" },
          { value: "Charlotta", icon: "/games/GBVSR/GBVSR_Charlotta_Icon.png", iconPosition:"50%60%" },
          { value: "Djeeta", icon: "/games/GBVSR/GBVSR_Djeeta_Icon.png", iconPosition:"50%55%" },
          { value: "Eustace", icon: "/games/GBVSR/GBVSR_Eustace_Icon.png", iconPosition:"50%60%" },
          { value: "Ferry", icon: "/games/GBVSR/GBVSR_Ferry_Icon.png", iconPosition:"50%55%" },
          { value: "Gran", icon: "/games/GBVSR/GBVSR_Gran_Icon.png", iconPosition:"50%53%" },
          { value: "Grimnir", icon: "/games/GBVSR/GBVSR_Grimnir_Icon.png", iconPosition:"50%60%" },
          { value: "Katalina", icon: "/games/GBVSR/GBVSR_Katalina_Icon.png", iconPosition:"50%55%" },
          { value: "Ladiva", icon: "/games/GBVSR/GBVSR_Ladiva_Icon.png", iconPosition:"50%40%" },
          { value: "Lancelot", icon: "/games/GBVSR/GBVSR_Lancelot_Icon.png", iconPosition:"50%60%" },
          { value: "Lowain", icon: "/games/GBVSR/GBVSR_Lowain_Icon.png", iconPosition:"50%50%" },
          { value: "Metera", icon: "/games/GBVSR/GBVSR_Metera_Icon.png", iconPosition:"50%55%" },
          { value: "Narmaya", icon: "/games/GBVSR/GBVSR_Narmaya_Icon.png", iconPosition:"50%65%" },
          { value: "Nier", icon: "/games/GBVSR/GBVSR_Nier_Icon.png", iconPosition:"50%62%" },
          { value: "Percival", icon: "/games/GBVSR/GBVSR_Percival_Icon.png" },
          { value: "Seox", icon: "/games/GBVSR/GBVSR_Seox_Icon.png", iconPosition:"50%60%" },
          { value: "Siegfried", icon: "/games/GBVSR/GBVSR_Siegfried_Icon.png" },
          { value: "Soriz", icon: "/games/GBVSR/GBVSR_Soriz_Icon.png" },
          { value: "Vaseraga", icon: "/games/GBVSR/GBVSR_Vaseraga_Icon.png", iconPosition:"50%55%" },
          { value: "Vira", icon: "/games/GBVSR/GBVSR_Vira_Icon.png", iconPosition:"50%55%" },
          { value: "Yuel", icon: "/games/GBVSR/GBVSR_Yuel_Icon.png", iconPosition:"50%60%" },
          { value: "Zeta", icon: "/games/GBVSR/GBVSR_Zeta_Icon.png", iconPosition:"50%60%" },
          { value: "Zooey", icon: "/games/GBVSR/GBVSR_Zooey_Icon.png", iconPosition:"50%65%" },
        ],
      },
      {
